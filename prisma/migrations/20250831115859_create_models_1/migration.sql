...
-- CreateTable
CREATE TABLE "public"."InterviewAssess" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    ...
    CONSTRAINT "InterviewAssess_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "InterviewAssess_userId_idx" ON "public"."InterviewAssess"("userId");
...
-- AddForeignKey
ALTER TABLE "public"."InterviewAssess" ADD CONSTRAINT "InterviewAssess_userId_fkey" FOREIGN KEY ("userId") REFERENCES "public"."User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
